...
Timer(Timer_Name := "", Timer_Opt := "D")
{
	...
	if (Timer_Opt = "M" or Timer_Opt = "Minus")
	{
		Timer[Timer_Name,"Start"] := Timer[Timer_Name,"Start"] - 500
		Timer[Timer_Name,"Finish"] := Timer[Timer_Name,"Start"] + Timer[Timer_Name,"Period"] - 500
	}
	if (Timer_Opt = "P" or Timer_Opt = "Plus")
	{
		Timer[Timer_Name,"Start"] := Timer[Timer_Name,"Start"] + 1000
		Timer[Timer_Name,"Finish"] := Timer[Timer_Name,"Start"] + Timer[Timer_Name,"Period"]
	}
